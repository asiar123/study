...
class matery(models.Model):
	...
	Matematicas14 = models.CharField(max_length=100, null=True)
	Matematicas15 = models.CharField(max_length=100, null=True)
	Matematicas16 = models.CharField(max_length=100, null=True)
	Matematicas17 = models.CharField(max_length=100, null=True)
	Matematicas18 = models.CharField(max_length=100, null=True)
